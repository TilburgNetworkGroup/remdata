...
#' 
#' This dataset contains the sequence of 77521 face-to-face contacts between 
#' primary school students and their teachers in Lyon, France on Thursday 
#' October 1st and Friday October 2nd 2009. The data collection involved 232 
#' students of five different grades of each two classes (i.e., 10 classes in 
#' total) and 10 teachers. Wearable proximity sensors recorded with a 20-second 
#' time interval every face-to-face contact between individuals that was active 
#' in the last 20 second window. A contact between two individuals is defined 
#' as the set of successive time-windows of 20 seconds during which the 
...
#' class/role of the students and teachers is available in the 'attributes' 
#' element. 
#' 
#' @docType data
#' 
...
#' 
#' @section edgelist:
#' Dataframe with 77521 rows and 4 columns that contains the relational event 
...
#' contact in seconds since onset of the study period.}
...
#' all entries.}
#'  \item{class}{String with the grade and class/role of the students and 
#' teachers.}
