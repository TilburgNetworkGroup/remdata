...
#' 
#' @section edgelist:
#' Dataframe with 33751 rows and 4 columns that contains the relational event 
...
#' 
#' @section attributes:
#' Dataframe with 232 rows and 3 columns describing the department of the 
#' employees.
#' \describe{
...
#' all entries.}
#'  \item{department}{String with the department of the employee.}
#' }
#' 
