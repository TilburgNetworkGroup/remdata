...
#' 
#' @section edgelist:
#' Dataframe with 31861 rows and 4 columns that contains the relational event 
#' sequence with interactions between pairs of baboons.
#' \describe{
#'  \item{time}{Numeric value indicating the timestamp for the onset of the 
#' event expressed in unix time}
...
#' 
#' @section actors:
#' Vector with the names of the 13 baboons for which interactions were recorded.
#' 
