...
#' }
#'
#' @source \url{https://sociopatterns.org/datasets/sfhh-conference-data-set/}
#'
#' @references Cattuto et al. (2010) PloS ONE 5(7) e11596 \doi{10.1371/journal.pone.0011596}, Genois & Barrat (2018) EPJ Data Science 7:11 \doi{10.1140/epjds/s13688-018-0140-1}, Stehle et al. (2011) BMC Medicine 9(87) \doi{10.1186/1741-7015-9-87}
"SFHHconference"
